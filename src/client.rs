...
impl<C: CANInterface<ClientCmd>, D: Dictionary> ClientCtx<C, D>
where
    ...
    D::Object: for<'a> TryFrom<(Index, &'a [u8])>
{
    ...
    where
        E: From<<C as CANInterface<ClientCmd>>::Error> + From<SdoError> + for<'a> From<<D::Object as TryFrom<(Index, &'a [u8])>>::Error>,
    {
